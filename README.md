...
This is a [Next.js](https://nextjs.org) project bootstrapped with [`create-next-app`](https://nextjs.org/docs/app/api-reference/cli/create-next-app) and [Next.js PWA guide](https://nextjs.org/docs/15/app/guides/progressive-web-apps).
